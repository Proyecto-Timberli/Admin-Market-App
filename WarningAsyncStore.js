//Remplazar Index.js en node_modules / @ firebase / auth / dist / rn'. 
//por este archivo para evitar warnings referidos a Async Store
...
var phone = require('./phone-eec7f987.js');
...
var reactNativeLocalPersistence = getReactNativePersistence({
    ...
    getItem: function () {
        ...
        return (_a = AsyncStorage).getItem.apply(_a, args);
    },
    setItem: function () {
        var AsyncStorage = require('../../../../@react-native-async-storage/async-storage')
        var _a;
        ...
        return (_a = AsyncStorage).setItem.apply(_a, args);
    },
    removeItem: function () {
        var AsyncStorage = require('../../../../@react-native-async-storage/async-storage')
        var _a;
        ...
        return (_a = AsyncStorage).removeItem.apply(_a, args);
    },
});
